...
class Processor(object):
    # def __init__(self, datadir="./data/conll2003"):
    def __init__(self, datadir="/home/PeifuHan/Knowledge_Graph/Named_Entity_Recognition/biobert-master/datasets/NER/BC2GM"):
    ...
    def load_data(self):
        ...
        for setname in datasets:
            ...
            datapath = os.path.join(self._datadir, "{}.tsv".format(setname))
    ...
    # def save_sen_label_adj(self, datadir="./var"):
    def save_sen_label_adj(self, datadir="./var_BC2GM"):
        """
